  ...
  template: `
    <main class="page">
      <form class="surface grid checkout" (ngSubmit)="pay()">
        <div class="stepper">
          <span class="active"><strong>1</strong>Búsqueda</span><span class="active"><strong>2</strong>Resultados</span><span class="active"><strong>3</strong>Cliente</span><span class="active"><strong>4</strong>Pasajero</span><span><strong>5</strong>Servicios</span><span><strong>6</strong>Reservar</span>
        </div>
        <h1>Registro de pasajero y pago</h1>
        <section class="passenger">
          <h2>Pasajero 1 - Adulto</h2>
          <div class="form-row">
            <mat-form-field><mat-label>Título</mat-label><mat-select name="title" [(ngModel)]="title" required><mat-option value="Sr.">Sr.</mat-option><mat-option value="Sra.">Sra.</mat-option></mat-select></mat-form-field>
            <mat-form-field><mat-label>Género</mat-label><mat-select name="gender" [(ngModel)]="gender" required><mat-option value="MASCULINO">Masculino</mat-option><mat-option value="FEMENINO">Femenino</mat-option></mat-select></mat-form-field>
          ...
          <div class="form-row">
            ...
            <mat-form-field><mat-label>Número documento</mat-label><input matInput name="doc" [(ngModel)]="documentId" required></mat-form-field>
            <mat-form-field><mat-label>Expiración</mat-label><input matInput name="docExp" [(ngModel)]="documentExpiration" placeholder="2030-12-31" required></mat-form-field>
            <mat-form-field><mat-label>País emisión</mat-label><input matInput name="docCountry" [(ngModel)]="documentCountry" required></mat-form-field>
          </div>
        </section>
...
export class CheckoutComponent implements OnInit {
  ...
  title = 'Sr.'; gender = 'MASCULINO'; birthDate = ''; nationality = 'Guatemala'; documentType = 'DPI';
  documentId = ''; documentExpiration = ''; documentCountry = 'Guatemala'; frequentFlyer = '';
  ...
  pay() {
    this.api.checkout({ flightId: this.flightId, seatNumber: this.seatNumber, cardHolder: this.cardHolder, cardNumber: this.cardNumber, expiry: this.expiry, cvv: this.cvv,
      title: this.title, gender: this.gender, birthDate: this.birthDate, nationality: this.nationality, documentType: this.documentType,
      documentId: this.documentId, documentExpiration: this.documentExpiration, documentCountry: this.documentCountry, frequentFlyer: this.frequentFlyer })
